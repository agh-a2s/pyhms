...
class SproutMechanism():
    ...
    def get_seeds(self, tree) -> Dict[AbstractDeme, Tuple[Dict[str, float], List[Individual]]]:
        ...
        return self.apply_tree_filters(candidates, tree)
...
def get_simple_sprout(far_enough: float) -> SproutMechanism:
    return SproutMechanism(BestPerDeme(), [FarEnough(far_enough, 2)], [LevelLimit(4)])